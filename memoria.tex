...
\juradoTRES{Esp. Ing. Esteban Daniel Volentini (UNT, FIUBA)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur3name
...
A los profesores de la Carrera de Especialización en Sistemas Embebidos, por colaborar en mi formación académica con sus conocimientos y experiencias.
...
\dedicatory{\textbf{Este trabajo lo dedico a mi familia, gracias eternas por su apoyo incondicional en cada etapa de mi vida. Ustedes son la luz que guía mi camino}}  % escribir acá si se desea una dedicatoria
